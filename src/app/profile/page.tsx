          ...
          <form action={updateUserProfile} className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="space-y-2">
                ...
                <Select name="activityLevel" defaultValue={profile?.activity_level ?? 'Sedentary'}>
            ...
            <div className="space-y-2">
              ...
              <Textarea id="fitnessGoals" name="fitnessGoals" placeholder="e.g., Lose 10 pounds, build muscle, improve cardio..." defaultValue={profile?.fitness_goals ?? ''} />
            </div>

            <div className="space-y-2">
              <Label htmlFor="medicalConditions">Medical Conditions</Label>
              <Textarea id="medicalConditions" name="medicalConditions" placeholder="Please list any relevant medical conditions, e.g., diabetes, high blood pressure." defaultValue={profile?.medical_conditions ?? ''}/>
            </div>

            <div className="space-y-2">
              <Label htmlFor="dietaryPreferences">Dietary Preferences</Label>
              <Textarea id="dietaryPreferences" name="dietaryPreferences" placeholder="e.g., I love Mediterranean food, prefer quick meals, dislike spicy food." defaultValue={profile?.dietary_preferences ?? ''}/>
            </div>

            <div className="space-y-2">
              <Label htmlFor="preferredCuisine">Preferred Cuisine</Label>
              <Textarea id="preferredCuisine" name="preferredCuisine" placeholder="e.g., Italian, Mexican, Asian, etc." defaultValue={profile?.preferred_cuisine ?? ''}/>
            </div>

            <div className="space-y-2">
              <Label htmlFor="allergies">Allergies</Label>
              <Textarea id="allergies" name="allergies" placeholder="e.g., Peanuts, shellfish, gluten." defaultValue={profile?.allergies ?? ''}/>
            </div>
