...
CREATE TYPE dietary_preference AS ENUM ('none', 'vegetarian', 'vegan', 'pescatarian', 'keto', 'paleo', 'mediterranean', 'gluten_free', 'dairy_free');
CREATE TYPE goal_type AS ENUM ('weight_loss', 'muscle_gain', 'maintenance', 'athletic_performance', 'general_health');
